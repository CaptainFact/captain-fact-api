defmodule CaptainFact.VideoDebate.ActionCreator do
  ...
  def action_create(user_id, video_id, statement = %Statement{id: id}),
    do:
      action(user_id, video_id, @entity_statement, id, @action_create, %{
        text: statement.text,
        time: statement.time,
  ...
  def action_create(user_id, video_id, speaker = %Speaker{id: id}),
    do:
      action(user_id, video_id, @entity_speaker, id, @action_create, %{
  ...
  def action_add(user_id, video_id, speaker = %Speaker{id: id}),
    do:
      action(user_id, video_id, @entity_speaker, id, @action_add, %{
        full_name: speaker.full_name,
        title: speaker.title
      })
