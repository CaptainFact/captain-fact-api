defmodule CF.Web.VideoDebateHistoryChannel do
  @moduledoc """
  ...
  import CF.Web.UserSocket, only: [handle_in_authenticated: 4]
  ...
  alias CF.Web.{StatementView, SpeakerView, UserActionView}
