defmodule CF.Web.UserSocket do
  use Phoenix.Socket

  require Logger
  import Guardian.Phoenix.Socket
  alias CF.Web.{ErrorView, ChangesetView}
  alias CF.Accounts.UserPermissions
  alias CF.Authenticator.GuardianImpl

  ## Channels
  channel("video_debate:*", CF.Web.VideoDebateChannel)
  channel("video_debate_history:*", CF.Web.VideoDebateHistoryChannel)
  channel("statement_history:*", CF.Web.VideoDebateHistoryChannel)
  channel("statements:video:*", CF.Web.StatementsChannel)
  channel("comments:video:*", CF.Web.CommentsChannel)
