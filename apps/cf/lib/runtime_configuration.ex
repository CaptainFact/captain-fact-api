defmodule CF.RuntimeConfiguration do
  ...
  weave(
    ...
    handler: fn url ->
      ...
      put_in_env(:cf, [:frontend_url], url)
      add_url_to_cors(url)
    end
  )
  ...
  # Youtube API key
  weave("youtube_api_key", handler: {:cf, :youtube_api_key})
