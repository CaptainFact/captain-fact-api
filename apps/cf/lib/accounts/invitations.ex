defmodule CF.Accounts.Invitations do
  @moduledoc """
  Invitation system. Generate invites, validate them...

  Can be bypassed by setting the {:cf, :invitation_system} env variable
  ...
  """
  def enabled?, do: Application.get_env(:cf, :invitation_system)

  @doc """
  Enable the invitation system
  """
  def enable, do: Application.put_env(:cf, :invitation_system, true)

  @doc """
  Disable the invitation system
  """
  def disable, do: Application.put_env(:cf, :invitation_system, false)
  ...
  def send_invite(request = %InvitationRequest{}) do
    ...
    |> CF.Mailer.Email.invitation_to_register()
