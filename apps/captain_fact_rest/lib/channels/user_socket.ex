defmodule CaptainFactREST.UserSocket do
  use Phoenix.Socket

  require Logger
  import Guardian.Phoenix.Socket
  alias CaptainFactREST.{ErrorView, ChangesetView}
  alias CaptainFact.Accounts.UserPermissions

  ## Channels
  channel "video_debate:*", CaptainFactREST.VideoDebateChannel
  channel "video_debate_history:*", CaptainFactREST.VideoDebateHistoryChannel
  channel "statement_history:*", CaptainFactREST.VideoDebateHistoryChannel
  channel "statements:video:*", CaptainFactREST.StatementsChannel
