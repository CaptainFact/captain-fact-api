defmodule CaptainFactREST.VideoDebateHistoryChannel do
  use CaptainFactREST, :channel
  require Logger

  import CaptainFact.VideoDebate.ActionCreator, only: [action_restore: 3]
  import CaptainFactREST.UserSocket, only: [handle_in_authenticated: 4]
  ...
  alias CaptainFactREST.{StatementView, SpeakerView}
  alias CaptainFactREST.UserActionView
