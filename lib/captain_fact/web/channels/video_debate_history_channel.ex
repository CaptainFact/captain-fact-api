defmodule CaptainFact.Web.VideoDebateHistoryChannel do
  ...
  alias CaptainFact.Web.{ Statement, Speaker, VideoSpeaker, VideoDebateAction, VideoDebateActionView, StatementView, SpeakerView }
